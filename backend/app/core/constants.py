...
REFINERY_PROXIMITY_M: int = 2_000        # leave — sparsity issue, not threshold issue
OIL_GAS_PROXIMITY_M: int = 2_000         # leave — same
INDUSTRIAL_PROXIMITY_M: int = 20_000     # 2km -> 20km
POWER_PLANT_PROXIMITY_M: int = 15_000    # 5km -> 15km
MINING_PROXIMITY_M: int = 20_000         # Baseline proximity to mining site (2 km)
